    ...
    <ul class="list">
      <li class="item">
        <div class="desc">
          ...
          <p>
            auto_catch 可以帮助你自动捕获 async 函数中的错误，不需要额外的 then
            catch 或是 try catch
          </p>
        </div>
      ...
      <li class="item">
        <div class="desc">
          ...
          <p>
            将一个对象绑定在 Vue
            的实例下，非响应。这在非常多数据需要绑定却不想全部都放在 data
            中(无需响应)时很有用。
          </p>
        </div>
        <div>
      ...
      <li class="item">
        <div class="desc">
          ...
          <p>
            当前函数在 Vue.nextTick 内运行。具体参见
            <a href="https://cn.vuejs.org/v2/api/#Vue-nextTick" target="_blank"
              >Vue.nextTick</a
            >
          </p>
        </div>
